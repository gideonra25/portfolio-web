      ...
      <div class="row justify-content-between">
        ...
        <div class="col-auto position-relative">
          ...
          <div class="pagination pe-5 pe-xl-6 d-none d-lg-flex" v-if="portfolioData">
            <i class="fa-light fa-angles-left fa-3x pagination--prev mouse-md"
               @click.prevent="paginatePrev" :class="{'disabled': selected === 0}"></i>
            <i class="fa-light fa-angles-right fa-3x pagination--next mouse-md"
...
useHead({
  title: 'Explore Projects | Gideon Ramot',
  meta: [
    {
      name: 'description',
